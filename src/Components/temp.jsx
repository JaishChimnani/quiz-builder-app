        ...
        return (
            <li className="m-5">
                ...
                {/* <div className="row">
                    ...
                    {formik.values.questions[index].options.map((item, i) => {
                        return (
                            <input value={formik.values.questions[index].options[i]} onChange={formik.handleChange} className="m-5 col-lg-3 " type="text" name="" id="" />
